...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
        ...
        "iframe-resizer": path.resolve(__dirname, 'node_modules/@digital-learning/iframe-resizer/iframeResizer.contentWindow.min'),
    }
  },
  plugins: [
        ...
        use: [{
          ...
          options: {
            ...
            outputPath: (url, resourcePath, context) => {
              ...
              // Any images in node_modules/@digital-learning/ will be copied/referenced as dependencies/{projectname}/img/
              if (/node_modules\/@digital-learning/.test(resourcePath)) {
                var p = String(resourcePath.split('/node_modules/@digital-learning/')[1])
                var slash = p.indexOf('/');
                var projectDir = p.substr(0, slash);

                return `../dependencies/${projectDir}/img/${url}`;

              // Any images NOT in node_modules/@digital-learning/ will be copied/referenced as assets/icons/
              } else {
